package com.bring.dat.views.bluetooth;
...
public class SmoothBluetooth {
    ...
    public void tryConnection() {
        ...
        Timber.e("Paired devices: %s", mDevices.size());
        if (!mDevices.isEmpty()) {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                Timber.e("Device found: " + device.getName() + " " + device.getAddress());
                if(!deviceExist(device)) {
                    mDevices.add(new Device(device.getName(), device.getAddress(), false));
                }
            } else if (BluetoothAdapter.ACTION_DISCOVERY_FINISHED.equals(action)) {
                Timber.e("Discovery finished: %s", mDevices.size());
                mContext.unregisterReceiver(mReceiver);
                if (mListener != null) {
