    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    ...
                    Timber.e(var3, "unable to close() socket during connection failure");
                }
        ...
        public void cancel() {
            try {
                ...
                Timber.e(var2, "close() of connect socket failed");
            }
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            if (socket != null) {
                try {
                    ...
                    Timber.e(var6, "temp sockets not created");
                }
            }
        ...
        public void write(byte[] buffer) {
            try {
                ...
                Timber.e(var3, "Exception during write");
            }
